...
export default {
  ...
  methods: {
    ...
    jumpToReceiveInAdvance: function (row) {
      this.$router.push('../receiveInAdvance/' + row.id)
    },
    jumpToIncomeConfirmation: function (row) {
      this.$router.push('../incomeConfirmation/' + row.id)
    },
    jumpToOutcomeConfirmation: function (row) {
      this.$router.push('../outcomeConfirmation/' + row.id)
    },
